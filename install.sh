...
# Early PHP check - many commands in this script require PHP
if ! command -v php >/dev/null 2>&1; then
    echo -e "\033[0;31m✗ PHP is required but not installed.\033[0m"
    echo ""
    echo "Install PHP 8.1+ first:"
    echo "  Ubuntu/Debian: sudo apt install php php-cli php-sqlite3 php-mbstring"

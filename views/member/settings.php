            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <h5 class="mb-3">Builder — Model Preferences</h5>
                        ...
                        <div class="mb-3 border rounded p-3">
                            ...
                            <div class="form-text small mt-2">
                                <i class="bi bi-key me-1"></i>Your own API key for a provider (Anthropic, Ollama, OpenRouter, z.ai …)
                                is a model connection now: <a href="/connections#models">Connections → Models</a>.
                            </div>
                        </div>
                        <?php endforeach; ?>
                        <?php endif; ?>

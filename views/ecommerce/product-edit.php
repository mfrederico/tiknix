    ...
    <div class="card-body">
      ...
      <div class="row g-3">
        <div class="col-sm-6">
          ...
          <div class="form-text">Letters, numbers, dashes. Used as the file name and URL.</div>
        </div>
        <div class="col-sm-6">
      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2 mb-3">
          <?php foreach (($p['images'] ?? []) as $img): ?>
            <img src="<?= htmlspecialchars($imgUrl($img)) ?>" alt="" style="width:72px;height:72px;object-fit:cover;border-radius:6px" onerror="this.style.opacity=.3">
          <?php endforeach; ?>
...
(function(){
  ...
  document.getElementById('productForm').addEventListener('submit', function(ev){
    ...
    fetch('/ecommerce/productsave', {
      ...
      if (j && j.success) { location.href = '/ecommerce/productedit?sku=' + encodeURIComponent(j.data.sku); }

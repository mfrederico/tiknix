...
class Feature {
    ...
    public const CATALOG = [
        ...
        // 'start' (the Get-started wizard, START-PLAN.md) is NOT a sidecar: it is built as
        // an ordinary project created in the UI (2026-09-25), so no feature flag names it.
        'workbench' => [
            'label'     => 'Builder',
